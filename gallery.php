...
function fetch($companyname)
{   

  //query to images of entered company
  $query = "SELECT images FROM images WHERE companyid=(SELECT id FROM company WHERE companyname = '$companyname')";
  ...
  while( $row = $result->fetch_assoc())
  {
    $output  .= '<div class="companyimages">
                        <a data-toggle="lightbox" href="images/'.$row["images"].'">
...
$result = fetchfunction($query);?>
            ...
            <div class="heading">
                <h4 style="text-align:center; font-weight:bold;"> <?php echo $_GET['companyname']?> </h4  >
            </div>
